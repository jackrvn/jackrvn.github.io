...
const ShetlandDialectPrivacyPolicy: React.FC = () => {
  return (
    <main className="container mx-auto px-4 py-12 max-w-3xl">
      <h1 className="text-3xl font-bold mb-8">
        Shetland Dialect Privacy Policy
      </h1>

      <article className="prose prose-slate max-w-none space-y-6">
        <section>
          <p>
            Shetland ForWirds provides the Shetland Dictionary app as a Free
            app. This SERVICE is provided by Shetland ForWirds at no cost and is
          ...
          <p>
            ...
            our Terms and Conditions, which are accessible at Shetland
            Dictionary unless otherwise defined in this Privacy Policy.
          </p>
        </section>
        ...
        <section>
          ...
          <p>Data is not collected by this app.</p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            through the Application and/or Services without their permission.
          </p>
          <p>
            You must be at least 16 years of age to consent to the processing of
        ...
        <section>
          ...
          <p>This policy is effective as of 2022-06-21</p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            <a
              href="mailto:info@shetlanddialect.org.uk"
              className="text-blue-600 hover:text-blue-800"
            >
              info@shetlanddialect.org.uk
            </a>
          </p>
        </section>
      </article>
...
export default ShetlandDialectPrivacyPolicy;
